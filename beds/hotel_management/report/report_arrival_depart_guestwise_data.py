    ...
    def get_guest_arrival_dept_information(self, objects):
        ...
        if history_ids:
            for room in history_ids:
                if room.history_id.name == 'Breakfast':
                    continue
                if room.history_id.name == 'All Meals':
                    continue
                if room.history_id.name == 'Breakfast And Dinner':
                    continue
                meal_plan_dict = {
                   'all_meals': 'All Meals',
                   'no_meals': 'No Meals',
                ...
                cus_res = {
                    ...
                    'complimentary': meal_plan_dict.get(room.booking_id.complimentary, 'Unknown') ,
                    'sn': sn,
                }
